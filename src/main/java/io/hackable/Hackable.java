...
public final class Hackable {
    ...
    public static <T> void before(String actionName, Handler<T> actionHandler) {
        doAction(Context.BEFORE, actionName, actionHandler);
    }

    public static <T> void after(String actionName, Handler<T> actionHandler) {
        doAction(Context.AFTER, actionName, actionHandler);
    }
    ...
    private static <T> void doAction(Context context, String actionName, Handler<T> actionHandler) {
